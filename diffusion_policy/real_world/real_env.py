...
from diffusion_policy.real_world.piper_controller_dev import PiperController
...
class PiperRealEnv:
    def __init__(self, 
        ...
        robot = PiperController(
            ...
            frequency=1000,  # Adjusted frequency for Piper
    ...
    def exec_actions(self,
        ...
        # print("exist_new_timestamps", new_timestamps)
        # print("exist_new_stages", new_stages)
        # print("exist_new_actions", new_actions)
        with open("/home/zcai/jh_workspace/diffusion_policy/exist_new_actions.txt", "a") as f:
