        ...
        with KeystrokeCounter() as key_counter, \
            ...
            while not stop:
                ...
                if freeze:
                    ...
                    target_pose[3:6] = current_rot_vec
                    ...
                    target_pose = env.get_robot_state()['ActualTCPPose']
                    current_quat = R.from_euler('xyz', target_pose[3:6], degrees=True).as_quat()
                    ...
                    target_pose[0] = target_pose[0] + delta_pos[0]
                    target_pose[1] = target_pose[1] + delta_pos[1]
                    target_pose[2] = target_pose[2] + delta_pos[2]
